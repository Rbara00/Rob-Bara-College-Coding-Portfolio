...
studentlist["tuj79644"]="yoo"
studentlist["tuf84141"]="li"
...
submit_command = "find . -type f -not -executable | rsync -v --files-from=- --exclude="".*"" --exclude=""submit.py"" --exclude=""*.txt"" . " + target_dir + "/."
