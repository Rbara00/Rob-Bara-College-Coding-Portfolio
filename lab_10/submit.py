...
submit_command = "find . -type f ! -executable | rsync -v --files-from=- --exclude=\"*.o\" --exclude=\".*\" --exclude=\"*.py\" --exclude=\"*.txt\" . " + target_dir + "/."
os.system(submit_command)

submit_command = "find . -type f -iname \"*.py\" | rsync -v --files-from=- --exclude=\".*\" --exclude=\"submit.py\" --exclude=\"*.txt\" . " + target_dir + "/."
os.system(submit_command)
